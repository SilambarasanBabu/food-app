  ...
  return (
    <>
      <div className="body-container">
        <div className="p-4 m-4 w-[240px] h-[370] border border-solid border-green-300 rounded-lg bg-green-50 hover:bg-green-100 shadow-lg">
          <div className="image-container">
            <img
              className="card-image h-[160]"
